...
class InSalesUploader {
  ...
  uploadAsset(owner, _asset, _path, task) {
    return uploadAsset(this, _asset, _path, task);
  }

  removeAsset(owner, _assetId, _path, _name, task) {
    return removeAsset(this, _assetId, _path, _name, task);
  }

  editAsset(owner, _asset, assetId, path, task) {
    return editAsset(this, _asset, assetId, path, task);
  }
  ...
  pushTheme() {
    return pushTheme(this.paths, this.assets, this);
  }

  pullTheme() {
    return Promise.all([pullTheme(this, this.paths)]);
  }
