...
export function instance (owner) {
  ...
  instanceDefault.folders = {
      'template': owner.options.root+'/templates/',
    ...
    instanceDefault.assets = {
      ...
      'Asset::Media': {
        ...
        'release': `${owner.options.root}/release/media/`,
